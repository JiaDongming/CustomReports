<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report4.aspx.cs" Inherits="CustomReports.Report4" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <table style="width:100%;height:100%; border-collapse:separate; border-spacing:10px;">
                    ...
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem4">
                            <div class="globalReportItemHeader4">
                                <div class="globalHeaderLeft4">设置</div>
                ...
                <tr>
                    <td style="width:100%; vertical-align:middle">
                        <div class="DivGlobalReportItem4">
                            <div class="globalReportItemHeader4">
                                <div class="globalHeaderLeft4">测试报表4</div>
                                <div class="globalHeaderMiddle4">&nbsp;</div>
        ...
        <script src="JS/Report4.js" type="text/javascript"></script>
</body>
</html>